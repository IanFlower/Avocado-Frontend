<template>
  <v-container>
          ...
          <v-card-title class="d-flex justify-space-between align-center">
            <v-row class="w-100" align="center">
              ...
              <v-col cols="2" sm="4" class="text-right">
                <v-btn color="#004761" dark @click="showAddRewardModal = true" class="w-auto">
    ...
    <!-- Add Reward Modal -->
    <AddReward v-model="showAddRewardModal" />
  </v-container>
</template>
...
const showAddRewardModal = ref(false); // Controls modal visibility
