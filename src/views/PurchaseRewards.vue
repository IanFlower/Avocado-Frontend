<template>
  ...
  try {
    console.log("Attempting to update reward:", selectedReward.value);

    // Ensure we're passing the entire reward object, not just purchaseCount
    const updatedReward = { 
      ...selectedReward.value, 
      purchaseCount: selectedReward.value.purchaseCount + 1 
    };
